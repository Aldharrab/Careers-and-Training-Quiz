const questions = [
    {
        question: "Which cybersecurity field resonates most with you?",
        options: ["begin"]
    },
    {
...
function showResults() {
    ...
    switch (maxCategory) {
        case "Penetration Testing":
            redirectPage = "./PenetrationTesting.html"; //  HTML page for Penetration Testing
            break;
        case "Cloud Security":
            redirectPage = "./CloudSecurity.html"; //  HTML page for Cloud Security
            break;
        case "Application Security":
            redirectPage = "./ApplicationSecurity.html"; //  HTML page for Application Security
            break;
        case "Operational Security":
            redirectPage = "./OperationalSecurity.html"; //  HTML page for Operational Security
            break;
        case "Bug Hunter":
